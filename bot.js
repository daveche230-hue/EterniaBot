...
let CLAN_ADS = [
    "!&5&lСейчас проходит набор в клан Eternia &f&lв нем вы получите 1лям,флай,крутых тимейтов, красивый кх,доступ в билд зону,лучший пвп кит,розыгрыши доната. &d&l&nЧтобы вступить пиши /warp Et или /c join Eternia ждём именно тебя",
    "!&6&lEternia &f&lнабирает новых членов! &5&lПолучи 1лям, флай, лучший пвп кит и участвуй в розыгрышах доната. Крутая команда и красивый кланхом ждут тебя.&6&l&n /c join Eternia или /warp et",
    "!&d&lВступай в &5&lEternia &d&lи получай привилегии! 1лям + флай + пвп кит + розыгрыши. Красивый клан хом, билд зона, крутые тимейты. &6&f&n/warp Et или /c join Eternia",
    "!&5&lEternia &f&lсейчас ищет людей! Тебя ждут: 1лям, флай, лучший кит, розыгрыши доната и крутая команда.&6&l&n /c join Eternia или /warp Et - заходи!",
...
// Инициализируем счётчики для каждой рекламы
        ...
        if (lowerText.includes('fly') || lowerText.includes('money')) {
            ...
            if (cmdMatch && cmdMatch[1] !== mcBot.username) {
                if (cmdMatch[2].toLowerCase() === 'fly') {
                    ...
                    mcBot.chat(`/eco give ${cmdMatch[1]} 1m`);
                }
            }
        }
    });
